...
pdf.move_up(320)
pdf.image("#{RAILS_ROOT}/public/images/pdf/map-guide-markers.png", :width => (@map_width + 40), :height => (@map_height + 20), :position => :center)
pdf.move_down(20)
...
table_content = @locations.map do |location|
	[
		...
		location.lat,
		location.lng,
# uncomment next line and add a column for "Pixel Index" to debug pixel translations
...
pdf.table table_content, 
	...
	:headers => ["Location Type", "Distance Miles", "Latitude", "Longitude", "Map Index"],
	:align => {0 => :left, 1 => :right, 2 => :right, 3 => :right, 4 => :center}
